      ...
      <div className="content-box">
        ...
        >
          <h1
            style={{
              ...
              color:
                props.Page === "UserWorkoutSchedulePage" ? "#000000FF" : "",
            }}
          >
            Workout
          </h1>
        ...
        >
          <Link
            ...
            style={{
              background:
                props.FoodMenu === "UserFoodSchedulePagePreWorkout"
                  ? "rgba(97, 209, 150, 0.25)"
                  : "",
            }}
          >
            <h1
          ...
          <Link
            ...
            style={{
              background:
                props.FoodMenu === "UserFoodSchedulePagePostWorkout"
                  ? "rgba(97, 209, 150, 0.25)"
                  : "",
            }}
          >
          ...
          <Link
            ...
            style={{
              background:
                props.FoodMenu === "UserFoodSchedulePageSnack"
                  ? "rgba(97, 209, 150, 0.25)"
                  : "",
            }}
          >
          ...
          <Link
            ...
            style={{
              background:
                props.FoodMenu === "UserFoodSchedulePageNormalMeal"
                  ? "rgba(97, 209, 150, 0.25)"
                  : "",
            }}
          >
          ...
          <Link
            ...
            style={{
              background:
                props.FoodMenu === "UserFoodSchedulePageFoodSchedule"
                  ? "rgba(97, 209, 150, 0.25)"
                  : "",
            }}
          >
